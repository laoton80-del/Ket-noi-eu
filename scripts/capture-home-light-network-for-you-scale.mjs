/**
 * Home light-network + For You scale QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-home-light-network-and-for-you-scale'
);
...
const VIEWPORTS = [
  { name: 'home-light-for-you-390x844', width: 390, height: 844 },
  { name: 'home-light-for-you-844x390', width: 844, height: 390 },
  { name: 'home-light-for-you-768x1024', width: 768, height: 1024 },
  { name: 'home-light-for-you-1024x768', width: 1024, height: 768 },
  { name: 'home-light-for-you-1366x768', width: 1366, height: 768 },
];
    ...
    () =>
      Boolean(
        document.querySelector('[data-testid="home-hero-network-edge"]') ||
          ...
          document.querySelector('[data-testid="home-premium-shell"]') ||
