/**
 * Local micro-scene asset system screenshot QA (hub-only, intent dismissed).
...
const OUT_DIR = path.join(__dirname, '..', 'docs', 'design', 'evidence', 'wave-3b-local-micro-scene');
...
const VIEWPORTS = [
  { name: 'local-micro-scene-390x844', width: 390, height: 844 },
  { name: 'local-micro-scene-844x390', width: 844, height: 390 },
  { name: 'local-micro-scene-768x1024', width: 768, height: 1024 },
  { name: 'local-micro-scene-1024x768', width: 1024, height: 768 },
  { name: 'local-micro-scene-1366x768', width: 1366, height: 768 },
];
