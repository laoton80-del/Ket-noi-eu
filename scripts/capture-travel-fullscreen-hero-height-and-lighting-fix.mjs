/**
 * Travel fullscreen hero height + lighting fix QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-fullscreen-hero-height-and-lighting-fix'
);
...
const VIEWPORTS = [
  { name: 'travel-fs-hero-light-390x844', width: 390, height: 844 },
  { name: 'travel-fs-hero-light-844x390', width: 844, height: 390 },
  { name: 'travel-fs-hero-light-768x1024', width: 768, height: 1024 },
  { name: 'travel-fs-hero-light-1024x768', width: 1024, height: 768 },
  { name: 'travel-fs-hero-light-1366x768', width: 1366, height: 768 },
  { name: 'travel-fs-hero-light-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
