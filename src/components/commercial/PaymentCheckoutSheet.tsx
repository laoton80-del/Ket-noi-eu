...
export function PaymentCheckoutSheet({ visible, onClose }: PaymentCheckoutSheetProps) {
  ...
  const sheetMode = useMemo<'centered' | 'bottom'>(() => {
    if (isWeb || isTablet) return 'centered';
    return 'bottom';
  }, [isTablet, isWeb]);
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={resetAndClose}>
      <View style={styles.backdrop}>
        ...
        <View style={[styles.sheetBase, sheetMode === 'centered' ? styles.sheetCentered : styles.sheetBottom]}>
