/**
 * Travel dynamic hero text density + premium copy QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-dynamic-hero-text-density-and-premium-copy'
);
...
const VIEWPORTS = [
  { name: 'travel-hero-copy-390x844', width: 390, height: 844 },
  { name: 'travel-hero-copy-844x390', width: 844, height: 390 },
  { name: 'travel-hero-copy-768x1024', width: 768, height: 1024 },
  { name: 'travel-hero-copy-1024x768', width: 1024, height: 768 },
  { name: 'travel-hero-copy-1366x768', width: 1366, height: 768 },
  { name: 'travel-hero-copy-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
