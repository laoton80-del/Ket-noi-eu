    ...
    return {
      ...
      data: {
        post: {
          ...
          content: 'Demo approved base — VIONA polyglot sandbox',
          approvedBaseContent: 'Demo approved base — VIONA polyglot sandbox',
          status: 'DRAFT',
          ...
          translations: [
            {
              ...
              languageCode: 'vi',
              translatedContent: '🔥 [DEMO VI] VIONA — dán thủ công vào nhóm, không spam API.',
            ...
            },
            {
              ...
              postId: 'demo-marketing-draft-1',
              languageCode: 'en',
              translatedContent: '🔥 [DEMO EN] VIONA — paste manually into groups.',
            ...
            },
            {
              ...
              postId: 'demo-marketing-draft-1',
              languageCode: 'ko',
              translatedContent: '🔥 [DEMO KO] VIONA — 클립보드에 복사 후 그룹에 붙여넣기.',
            ...
            },
            {
              ...
              postId: 'demo-marketing-draft-1',
              languageCode: 'de',
              translatedContent: '🔥 [DEMO DE] VIONA — manuell in Gruppen einfügen.',
      ...
      data: [
        {
          id: 'demo-marketing-draft-1',
          content:
            '🔥 Demo sandbox — VIONA đang bứt phá! #VIONA #InboundTourism ✨ (không gọi Facebook/OpenAI thật)',
                ...
                translations: [
                  {
                    ...
                    postId: 'demo-marketing-draft-1',
                    languageCode: 'vi',
                    translatedContent: '🔥 [DEMO VI] VIONA — dán thủ công vào nhóm.',
                    targetAudience: 'Vietnam domestic & Vietnamese diaspora',
                  },
                  {
                    id: 'demo-tr-en',
                    postId: 'demo-marketing-draft-1',
                    languageCode: 'en',
                    translatedContent: '🔥 [DEMO EN] VIONA — paste manually.',
                    targetAudience: 'US & English-speaking inbound tourists',
                  },
                  {
                    id: 'demo-tr-ko',
                    postId: 'demo-marketing-draft-1',
                    languageCode: 'ko',
                    translatedContent: '🔥 [DEMO KO] VIONA',
                    targetAudience: 'Korea — travelers interested in Vietnam',
                  },
                  {
                    id: 'demo-tr-de',
                    postId: 'demo-marketing-draft-1',
                    languageCode: 'de',
                    translatedContent: '🔥 [DEMO DE] VIONA',
                    targetAudience: 'Germany — Vietnamese community & EU corridor',
                  },
                ],
              }
  ...
  if (/\/api\/tourism\/wrap\/[^/]+$/i.test(p) && m === 'GET') {
    return {
      ...
      data: {
        ...
        languageCode: 'vi',
        viralTagline:
          'Bạn vượt qua giao thông Hà Nội và vẫn kịp 10 bát phở — VIONA đồng hành không tăng xông!',
    ...
    return {
      ...
      data: {
        ...
        draft: {
          ...
          content: '🔥 Demo cron — VIONA #VIONA #InboundTourism',
          status: 'DRAFT',
          createdAt: new Date().toISOString(),
        },
      } as T,
