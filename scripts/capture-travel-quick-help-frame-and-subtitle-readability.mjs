/**
 * Travel quick-help frame & subtitle readability — QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-quick-help-frame-and-subtitle-readability'
);
...
const TRAVEL_VIEWPORTS = [
  { name: 'travel-qh-390x844', width: 390, height: 844 },
  { name: 'travel-qh-844x390', width: 844, height: 390 },
  { name: 'travel-qh-768x1024', width: 768, height: 1024 },
  { name: 'travel-qh-1024x768', width: 1024, height: 768 },
  { name: 'travel-qh-1366x768', width: 1366, height: 768 },
  { name: 'travel-qh-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
