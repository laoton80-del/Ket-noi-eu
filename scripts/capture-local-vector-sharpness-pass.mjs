/**
 * Local vector micro-scene SHARPNESS PASS screenshot QA (hub-only, intent dismissed).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-vector-sharpness-pass'
);
...
const VIEWPORTS = [
  { name: 'local-sharp-390x844', width: 390, height: 844 },
  { name: 'local-sharp-844x390', width: 844, height: 390 },
  { name: 'local-sharp-768x1024', width: 768, height: 1024 },
  { name: 'local-sharp-1024x768', width: 1024, height: 768 },
  { name: 'local-sharp-1366x768', width: 1366, height: 768 },
];
