...
| FC-P0 Local provider authority staging execution preflight (E1) | **MERGED ON MASTER** — PR #425 squash `@ 098cb8709a980aa6a9df76a6ca6a1e4fffa9478d`; reviewed head `81004a6f4f1be374f6ee6b0fbd71f4c31b492636`; read-only staging preflight recorded; **strict review blocked** backup/restore freshness (`BLOCKED_E1_BACKUP_RESTORE_EVIDENCE_STALE_OR_INSUFFICIENT`); Pack A1 observed unapplied; Fly v28 / rollback v27 preserved. Evidence: `docs/product/VIONA_FC_P0_LOCAL_PROVIDER_AUTHORITY_STAGING_EXECUTION_PREFLIGHT_RESULT.md`. |
| FC-P0 Local provider authority E1 backup/restore evidence remediation | **READY FOR PR REVIEW** — operator phrase `APPROVE_VIONA_FC_P0_LOCAL_PROVIDER_AUTHORITY_E1_BACKUP_RESTORE_EVIDENCE_REMEDIATION`; baseline `098cb8709a980aa6a9df76a6ca6a1e4fffa9478d`; branch `docs/viona-fc-p0-local-provider-authority-e1-backup-restore-evidence-remediation`; corrects Pack A1 **Git/LF** checksum `3B028C85…` / 3471 B; withdraws unsupported `BACKUP_RESTORE_READINESS_CONFIRMED`; fresh `supabase backups list` blocked (no management token) → `BLOCKED_E1_EXPLICIT_FC_P0_RISK_ACCEPTANCE_REQUIRED`; risk-acceptance proposal **PROPOSED/NOT GRANTED**; **no** backup create / restore / migrate-apply / deploy / provider mutation / live QA; E2 **not** authorized; `REQUEST_ONLY_NO_CHARGE`; Pack40S **NOT AUTHORIZED**; Apple/EAS/Phase D2 deferred; Phase C closed green. Evidence: `docs/product/VIONA_FC_P0_LOCAL_PROVIDER_AUTHORITY_E1_BACKUP_RESTORE_EVIDENCE_REMEDIATION.md`, `docs/product/VIONA_FC_P0_LOCAL_PROVIDER_AUTHORITY_E2_BACKUP_RESTORE_RISK_ACCEPTANCE_PROPOSAL.md`. |
