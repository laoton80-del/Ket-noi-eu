/**
 * Local reference GLASS MATERIAL screenshot QA (hub-only).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-reference-glass-material-system'
);
...
const VIEWPORTS = [
  { name: 'local-glass-390x844', width: 390, height: 844 },
  { name: 'local-glass-844x390', width: 844, height: 390 },
  { name: 'local-glass-768x1024', width: 768, height: 1024 },
  { name: 'local-glass-1024x768', width: 1024, height: 768 },
  { name: 'local-glass-1366x768', width: 1366, height: 768 },
];
