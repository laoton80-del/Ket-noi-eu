...
| **Session 4 prep** | `VIONA_LOCAL_NO_CHARGE_CONTROLLED_PILOT_SESSION_4.md` — Option A; run pending |
| **Next** | Execute session 4 run (smoke + §7 evidence); optional native §8 on stable device — **do not claim native PASS** until checklist complete |
