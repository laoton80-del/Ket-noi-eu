/**
 * Home For You button scale QA captures.
...
const OUT_DIR = path.join(__dirname, '..', 'docs', 'design', 'evidence', 'wave-3b-home-for-you-scale');
...
const VIEWPORTS = [
  { name: 'home-for-you-scale-390x844', width: 390, height: 844 },
  { name: 'home-for-you-scale-844x390', width: 844, height: 390 },
  { name: 'home-for-you-scale-768x1024', width: 768, height: 1024 },
  { name: 'home-for-you-scale-1024x768', width: 1024, height: 768 },
  { name: 'home-for-you-scale-1366x768', width: 1366, height: 768 },
];
