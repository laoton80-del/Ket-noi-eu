/**
 * Travel secondary cinematic image-backed cards — QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-secondary-cinematic-image-backed-cards'
);
...
const VIEWPORTS = [
  { name: 'travel-img-390x844', width: 390, height: 844 },
  { name: 'travel-img-768x1024', width: 768, height: 1024 },
  { name: 'travel-img-1024x768', width: 1024, height: 768 },
  { name: 'travel-img-1366x768', width: 1366, height: 768 },
  { name: 'travel-img-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
