/**
 * Local dynamic hero title scale — QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-dynamic-hero-title-scale'
);
...
const LOCAL_VIEWPORTS = [
  { name: 'local-title-390x844', width: 390, height: 844 },
  { name: 'local-title-844x390', width: 844, height: 390 },
  { name: 'local-title-768x1024', width: 768, height: 1024 },
  { name: 'local-title-1024x768', width: 1024, height: 768 },
  { name: 'local-title-1366x768', width: 1366, height: 768 },
  { name: 'local-title-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
