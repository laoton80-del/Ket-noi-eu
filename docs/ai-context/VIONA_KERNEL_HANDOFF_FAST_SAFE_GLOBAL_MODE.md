...
| FC-P0 Local provider authority E8 staging client deployment readiness + prerequisite packet | **MERGED ON MASTER** — PR #436 squash `@ 7f001c6fd403be795c812e247856d23af08a148f` (reviewed head `b249166…`); docs-only; case `E8_CASE_A_DOCS_ONLY_RECOMMENDED`; Case B blockers preserved; E8 phrase remains NOT GRANTED. Post-merge verification **content preserved** but validation **not closed** (`BLOCKED_PR436_POST_MERGE_VALIDATION_TYPESCRIPT_RANGEERROR`). Evidence: `docs/product/VIONA_FC_P0_LOCAL_PROVIDER_AUTHORITY_E8_STAGING_CLIENT_DEPLOYMENT_READINESS_AND_PREREQUISITE_PACKET.md`. |
| PR #436 TypeScript RangeError no-product-change tooling triage | **MERGED / VERIFIED ON MASTER** — PR #437 squash `@ 48da52e4e2619a1b2e5a268e2841a858be1f4fae`; primary root cause `BLOCKED_TYPESCRIPT_RANGEERROR_INPUT_SCOPE_RECURSION`; PR #436 post-merge remained blocked pending tooling remediation at triage time. Evidence: `docs/product/VIONA_PR436_TYPESCRIPT_RANGEERROR_NO_PRODUCT_CHANGE_TOOLING_TRIAGE_PACKET.md`. |
| PR #436 TypeScript RangeError dist exclusion (no-product-change) | **READY FOR PR REVIEW** — operator phrase `APPROVE_VIONA_PR436_TYPESCRIPT_RANGEERROR_EXCLUDE_GENERATED_DIST_NO_PRODUCT_CHANGE_IMPLEMENTATION`; baseline `48da52e…`; branch `fix/viona-pr436-exclude-generated-dist-from-root-typecheck`; root `tsconfig.json` adds `dist/**` exclude; `GENERATED_DIST_EXCLUDED_FROM_ROOT_TYPESCRIPT_INPUT_SCOPE`; local `tsc` / `ci:expo-readiness` / `ci:release-discipline` PASS with dist present; post-`build:web` regen still excluded; `PR436_POST_MERGE_VALIDATION_READY_FOR_RECHECK_AFTER_DIST_EXCLUSION_REMEDIATION`; E8 Case A preserved; E8–E10 unauthorized. Evidence: `docs/product/VIONA_PR436_TYPESCRIPT_RANGEERROR_DIST_EXCLUSION_NO_PRODUCT_CHANGE_IMPLEMENTATION_RESULT.md`. |
