/**
 * Travel true parity lighting + lens cards QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-true-parity-lighting-and-lens-cards'
);
...
const VIEWPORTS = [
  { name: 'travel-parity-390x844', width: 390, height: 844 },
  { name: 'travel-parity-844x390', width: 844, height: 390 },
  { name: 'travel-parity-768x1024', width: 768, height: 1024 },
  { name: 'travel-parity-1024x768', width: 1024, height: 768 },
  { name: 'travel-parity-1366x768', width: 1366, height: 768 },
  { name: 'travel-parity-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
...
async function expandPerspectiveSection(page) {
  await page.evaluate(() => {
    const row = document.querySelector('[data-testid="travel-perspective-cards-row"]');
