...
| **Pack40D** | Indirect paths after per-path review | **D1–D3B MERGED**; **Pack40DD staged v27** (release integrity only; live execution QA still required); Pack40S unimplemented; Pack40D not CLOSED/GREEN |
