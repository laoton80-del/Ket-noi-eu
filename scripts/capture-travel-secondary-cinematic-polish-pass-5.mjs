/**
 * Travel secondary cinematic polish pass 5 — QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-secondary-cinematic-polish-pass-5'
);
...
const VIEWPORTS = [
  { name: 'travel-polish5-390x844', width: 390, height: 844 },
  { name: 'travel-polish5-768x1024', width: 768, height: 1024 },
  { name: 'travel-polish5-1024x768', width: 1024, height: 768 },
  { name: 'travel-polish5-1366x768', width: 1366, height: 768 },
  { name: 'travel-polish5-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
...
async function scrollForViewport(page, mobile) {
  await page.evaluate(({ mobile: isMobile }) => {
    ...
    if (isMobile) window.scrollBy(0, 64);
  }, { mobile });
