/**
 * Travel perspective hero cards row QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-perspective-hero-cards-row'
);
...
const VIEWPORTS = [
  { name: 'travel-perspective-390x844', width: 390, height: 844 },
  { name: 'travel-perspective-844x390', width: 844, height: 390 },
  { name: 'travel-perspective-768x1024', width: 768, height: 1024 },
  { name: 'travel-perspective-1024x768', width: 1024, height: 768 },
  { name: 'travel-perspective-1366x768', width: 1366, height: 768 },
  { name: 'travel-perspective-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
