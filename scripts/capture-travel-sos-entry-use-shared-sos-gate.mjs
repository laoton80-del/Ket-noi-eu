/**
 * Travel SOS entry shared gate — QA captures (rest state).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-sos-entry-use-shared-sos-gate'
);
...
const VIEWPORTS = [
  { name: 'travel-sos-gate-390x844', width: 390, height: 844 },
  { name: 'travel-sos-gate-844x390', width: 844, height: 390 },
  { name: 'travel-sos-gate-768x1024', width: 768, height: 1024 },
  { name: 'travel-sos-gate-1024x768', width: 1024, height: 768 },
  { name: 'travel-sos-gate-1366x768', width: 1366, height: 768 },
  { name: 'travel-sos-gate-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
