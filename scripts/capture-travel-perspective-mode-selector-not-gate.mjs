/**
 * Travel perspective mode selector (not gate) QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-perspective-mode-selector-not-gate'
);
...
const VIEWPORTS = [
  { name: 'travel-perspective-mode-390x844', width: 390, height: 844 },
  { name: 'travel-perspective-mode-844x390', width: 844, height: 390 },
  { name: 'travel-perspective-mode-768x1024', width: 768, height: 1024 },
  { name: 'travel-perspective-mode-1024x768', width: 1024, height: 768 },
  { name: 'travel-perspective-mode-1366x768', width: 1366, height: 768 },
  { name: 'travel-perspective-mode-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
...
async function waitForTravelOpeningStack(page) {
  ...
  await page.waitForSelector('[data-testid="travel-utility-grid"]', { timeout: 15_000 });
