...
| **Pack40D** | Indirect paths after per-path review | **D1 APPLIED/GREEN**; **D2 MERGED** (PR #371); **D3A MERGED** (PR #372); **D3B local controlled wiring** (single internal trigger; bypasses closed; no deploy); Pack40S unimplemented; Pack40D not CLOSED/GREEN |
