/**
 * Local "for you" Home-parity final screenshot QA.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-for-you-home-parity-final'
);
...
const VIEWPORTS = [
  { name: 'local-for-you-final-390x844', width: 390, height: 844 },
  { name: 'local-for-you-final-844x390', width: 844, height: 390 },
  { name: 'local-for-you-final-768x1024', width: 768, height: 1024 },
  { name: 'local-for-you-final-1024x768', width: 1024, height: 768 },
  { name: 'local-for-you-final-1366x768', width: 1366, height: 768 },
];
