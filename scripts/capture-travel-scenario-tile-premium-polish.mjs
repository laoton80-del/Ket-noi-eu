/**
 * Travel scenario tile premium polish QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-scenario-tile-premium-polish'
);
...
const VIEWPORTS = [
  { name: 'travel-scenario-tiles-390x844', width: 390, height: 844 },
  { name: 'travel-scenario-tiles-844x390', width: 844, height: 390 },
  { name: 'travel-scenario-tiles-768x1024', width: 768, height: 1024 },
  { name: 'travel-scenario-tiles-1024x768', width: 1024, height: 768 },
  { name: 'travel-scenario-tiles-1366x768', width: 1366, height: 768 },
  { name: 'travel-scenario-tiles-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
...
async function waitForTravelTiles(page) {
  await page.waitForSelector('[data-testid="travel-scenario-airport"]', { timeout: 60_000 });
  await page.waitForSelector('[data-testid="travel-quick-help-translation"]', { timeout: 15_000 });
}
