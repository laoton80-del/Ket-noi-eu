/**
 * Travel weather cinematic mini cards pack 1 — QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-weather-cinematic-mini-cards-pack-1'
);
...
const VIEWPORTS = [
  { name: 'weather-cinematic-390x844', width: 390, height: 844 },
  { name: 'weather-cinematic-768x1024', width: 768, height: 1024 },
  { name: 'weather-cinematic-1024x768', width: 1024, height: 768 },
  { name: 'weather-cinematic-1366x768', width: 1366, height: 768 },
  { name: 'weather-cinematic-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
...
async function openTravelRoute(page) {
  ...
  throw new Error('Travel cinematic weather row readiness failed.');
}
