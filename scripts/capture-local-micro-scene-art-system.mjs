/**
 * Local micro-scene ART SYSTEM screenshot QA (hub-only).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-micro-scene-art-system'
);
...
const VIEWPORTS = [
  { name: 'local-art-390x844', width: 390, height: 844 },
  { name: 'local-art-844x390', width: 844, height: 390 },
  { name: 'local-art-768x1024', width: 768, height: 1024 },
  { name: 'local-art-1024x768', width: 1024, height: 768 },
  { name: 'local-art-1366x768', width: 1366, height: 768 },
];
