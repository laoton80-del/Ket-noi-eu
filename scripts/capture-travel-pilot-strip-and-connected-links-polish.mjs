/**
 * Travel pilot strip + connected links polish QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-pilot-strip-and-connected-links-polish'
);
...
const VIEWPORTS = [
  { name: 'travel-pilot-links-390x844', width: 390, height: 844 },
  { name: 'travel-pilot-links-844x390', width: 844, height: 390 },
  { name: 'travel-pilot-links-768x1024', width: 768, height: 1024 },
  { name: 'travel-pilot-links-1024x768', width: 1024, height: 768 },
  { name: 'travel-pilot-links-1366x768', width: 1366, height: 768 },
  { name: 'travel-pilot-links-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
...
async function waitForTravelPilotStrip(page) {
  await page.waitForSelector('[data-testid="travel-pilot-strip"]', { timeout: 60_000 });
...
async function main() {
  ...
  try {
    for (const vp of VIEWPORTS) {
      ...
      await waitForTravelPilotStrip(page);
      await page.waitForTimeout(800);
