/**
 * Travel match Local opening stage final QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-match-local-opening-stage-final'
);
...
const VIEWPORTS = [
  { name: 'travel-local-opening-390x844', width: 390, height: 844 },
  { name: 'travel-local-opening-844x390', width: 844, height: 390 },
  { name: 'travel-local-opening-768x1024', width: 768, height: 1024 },
  { name: 'travel-local-opening-1024x768', width: 1024, height: 768 },
  { name: 'travel-local-opening-1366x768', width: 1366, height: 768 },
  { name: 'travel-local-opening-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
