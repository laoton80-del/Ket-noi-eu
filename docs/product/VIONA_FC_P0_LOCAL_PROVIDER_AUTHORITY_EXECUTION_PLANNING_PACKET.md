...
One `POST /api/local/ops/providers` @ `2026-07-23T16:01:33Z` → HTTP **201**; lifecycle **DRAFT**; visibility **false**; types `GENERIC_REQUEST`; audit **REGISTERED** only; `PATCH` count **0**.  
