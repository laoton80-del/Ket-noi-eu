/**
 * Local vector micro-scene FINAL REFERENCE PASS screenshot QA (hub-only).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-vector-final-reference-pass'
);
...
const VIEWPORTS = [
  { name: 'local-final-390x844', width: 390, height: 844 },
  { name: 'local-final-844x390', width: 844, height: 390 },
  { name: 'local-final-768x1024', width: 768, height: 1024 },
  { name: 'local-final-1024x768', width: 1024, height: 768 },
  { name: 'local-final-1366x768', width: 1366, height: 768 },
];
