...
| `APPROVE_PACK40DR1_RECOVERY_SCHEMA_PACKET` | Proposed next — additive lease-generation + durable redacted provider-reference schema only | recovery runtime, HTTP wiring, scheduler, live recon calls, staging, Pack40S |
