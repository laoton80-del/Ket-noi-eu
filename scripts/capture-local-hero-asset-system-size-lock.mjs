/**
 * Local hero asset system + size lock QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-hero-asset-system-size-lock'
);
...
const VIEWPORTS = [
  { name: 'local-hero-asset-lock-390x844', width: 390, height: 844 },
  { name: 'local-hero-asset-lock-844x390', width: 844, height: 390 },
  { name: 'local-hero-asset-lock-768x1024', width: 768, height: 1024 },
  { name: 'local-hero-asset-lock-1024x768', width: 1024, height: 768 },
  { name: 'local-hero-asset-lock-1366x768', width: 1366, height: 768 },
];
