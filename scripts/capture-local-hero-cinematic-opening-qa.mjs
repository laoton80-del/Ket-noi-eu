/**
 * Local hero cinematic opening QA screenshots.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-hero-cinematic-opening-qa'
);
...
const VIEWPORTS = [
  { name: 'local-hero-cinematic-390x844', width: 390, height: 844 },
  { name: 'local-hero-cinematic-844x390', width: 844, height: 390 },
  { name: 'local-hero-cinematic-768x1024', width: 768, height: 1024 },
  { name: 'local-hero-cinematic-1024x768', width: 1024, height: 768 },
  { name: 'local-hero-cinematic-1366x768', width: 1366, height: 768 },
];
