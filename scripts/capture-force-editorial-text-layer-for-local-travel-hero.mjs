/**
 * Force editorial text layer — Local + Travel dynamic hero QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-force-editorial-text-layer-for-local-travel-hero'
);
...
const ROUTE_CONFIG = {
  travel: {
    ...
    ready: '[data-testid="travel-hero-editorial-text-layer"]',
  },
  local: {
    routes: ['/local', '/tabs/local', '/LocalHub'],
    ready: '[data-testid="local-hero-editorial-text-layer"]',
  },
};
