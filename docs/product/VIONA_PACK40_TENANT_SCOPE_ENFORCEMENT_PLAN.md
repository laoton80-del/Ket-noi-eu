...
| **Pack40D** | Indirect paths after per-path review | **D1 schema foundation local** — attempt model + unapplied migration + unwired repository; next: merge D1 then separately authorize staging migration apply; D2/D3 unimplemented |
