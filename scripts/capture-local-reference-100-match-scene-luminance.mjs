/**
 * Local reference 100% match SCENE LUMINANCE screenshot QA (hub-only).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-reference-100-match-scene-luminance'
);
...
const VIEWPORTS = [
  { name: 'local-lum-390x844', width: 390, height: 844 },
  { name: 'local-lum-844x390', width: 844, height: 390 },
  { name: 'local-lum-768x1024', width: 768, height: 1024 },
  { name: 'local-lum-1024x768', width: 1024, height: 768 },
  { name: 'local-lum-1366x768', width: 1366, height: 768 },
];
