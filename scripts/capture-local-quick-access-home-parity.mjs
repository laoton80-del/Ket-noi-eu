/**
 * Local quick access Home parity + lighten screenshot QA.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-quick-access-home-parity'
);
...
const VIEWPORTS = [
  { name: 'local-quick-access-390x844', width: 390, height: 844 },
  { name: 'local-quick-access-844x390', width: 844, height: 390 },
  { name: 'local-quick-access-768x1024', width: 768, height: 1024 },
  { name: 'local-quick-access-1024x768', width: 1024, height: 768 },
  { name: 'local-quick-access-1366x768', width: 1366, height: 768 },
];
...
async function main() {
  ...
  try {
    for (const vp of VIEWPORTS) {
      ...
      await page.waitForSelector('[data-testid="local-opening-stage"]', { timeout: 60_000 });
