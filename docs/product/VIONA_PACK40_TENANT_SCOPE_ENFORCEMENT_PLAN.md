...
| **Pack40D** | Indirect paths after per-path review | **D1 staged schema applied** — PR #369 merged; staging migration applied; attempt table empty; no runtime wiring; D2/D3 unimplemented; evidence merge pending |
