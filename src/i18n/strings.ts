...
export const STRINGS_BY_LANGUAGE: Record<SupportedLanguage, AppStrings> = {
  vi: {
    ...
    reception: {
      screenTitle: 'Lễ tân',
      prepaidTitle: 'Gói VIG Token Global (Starter → Enterprise)',
      ...
      walletPackStarterCredits: '100 VIG Token',
      walletPackBasicCredits: '230 VIG Token',
      walletPackStandardCredits: '650 VIG Token',
    },
    country: {
      screenTitle: 'Quốc gia',
      subtitle: 'Chọn quốc gia hồ sơ — giá hiển thị & gói VIG Token theo nhóm thị trường Global.',
      countryNameByCode: {
        CZ: 'Séc',
        SK: 'Slovakia',
        PL: 'Ba Lan',
    ...
    utility: {
      ...
      packTurnsCredits: '{turns} VIG Token',
    ...
    profile: {
      ...
      creditsTitle: 'VIG Token',
      creditsBalance: 'Số dư đồng bộ từ máy chủ — xem mục Ví',
      creditsHint: 'Bạn có thể dùng VIG Token cho gọi điện ủy quyền, học tập và dịch vụ.',
      ...
      aiCreditsLabel: 'VIG Token dịch vụ',
      ...
      creditsBalanceCurrent: 'Số dư hiện tại: {credits} VIG Token',
    ...
    errors: {
      outOfCredits: 'Bạn đã hết VIG Token. Vui lòng nạp thêm để tiếp tục sử dụng CSKH Minh Khang.',
    },
    walletTopUp: {
      ...
      backendMissingBody:
        'Thiếu EXPO_PUBLIC_BACKEND_API_BASE — không thể cộng VIG Token an toàn. Kiểm tra biến môi trường build.',
      ...
      paymentNotVerifiedBody:
        'Thanh toán có thể đã xong nhưng máy chủ chưa xác nhận quyền nạp. VIG Token chưa được cộng. Bạn có thể thử lại.',
      paymentMissingIdTitle: 'Thanh toán',
      paymentMissingIdBody: 'Thiếu mã giao dịch thanh toán. Vui lòng chọn gói lại.',
      creditsNotCreditedTitle: 'Chưa cộng VIG Token',
      creditsNotCreditedBody:
        'Thanh toán có thể đã thành công nhưng sổ VIG Token trên máy chủ chưa cập nhật. Thử lại để hoàn tất (idempotent).',
      connectionInterruptedTitle: 'Gián đoạn kết nối',
      connectionInterruptedBody:
        'Không hoàn tất bước xác minh hoặc cộng VIG Token. Kiểm tra mạng; nếu đã trừ tiền, thử lại để đồng bộ.',
      pinWrongTitle: 'Không thể mở khóa',
      pinWrongBody: 'Mã PIN không đúng. Vui lòng thử lại.',
      closeCheckoutTitle: 'Đóng thanh toán',
      closeCheckoutBody:
        'Nếu bạn đã trả tiền, VIG Token có thể vẫn đang chờ máy chủ. Kiểm tra số dư hoặc mở lại gói nạp và thử đồng bộ.',
      unlockWalletTitle: 'Mở khóa Ví',
      pendingVerifyText: 'Đang xác minh thanh toán và cộng VIG Token trên máy chủ…',
      alertClose: 'Đóng',
      alertRetry: 'Thử lại',
      alertLater: 'Để sau',
      screenSubtitle: 'Ví VIG Token',
      balanceLabel: 'Số dư hiện tại',
      balanceHint:
        'Số dư VIG Token đồng bộ từ máy chủ sau đăng nhập. Giá gói theo tiền tệ địa phương theo quốc gia hồ sơ ({country}).',
      ...
      unitPriceLine:
        'Chỉ tham khảo (tiền địa phương ước tính — cuộc gọi trừ VIG Token): hỗ trợ trong app ({inboundName}): {inboundPrice} | gọi đối ngoại ({outboundName}): {outboundPrice}',
      ...
      balanceCreditsDisplay: '{credits} VIG Token',
      buyPackCtaLine: '{turns} VIG Token — {amount}',
    },
    nav: {
      countryTab: 'Quốc gia',
      utilityTab: 'Tiện ích',
