...
| **Pack40D** | Indirect paths after per-path review | **Initial controlled merchant execution CLOSED/GREEN** (PR #375+#376; staging **v28**; sole trigger `internalAuthenticatedController`); signed-webhook DISABLED; `approvedInternalDispatch` UNWIRED; consumer/legacy UNSUPPORTED; **Pack40DR audit #377**; **Pack40DR1 schema APPLIED**; **Pack40DR2/DR3A/DR3B merged**; **operator recovery DEPLOYED v28**; **Pack40DRS0 endpoint safety QA PASS** (PR #384); **Pack40DRS1 fixture readiness = BLOCKED_NO_SAFE_RECOVERABLE_ATTEMPT_FIXTURE** (1 attempt total, all completed, 0 non-terminal; no fixture created); functional non-terminal recovery **untested**; recovery **not** CLOSED/GREEN; Pack40S unauthorized |
