...
during Pack38's session — now have their own dedicated planning packet, Pack39 (see the table row
above and `docs/product/VIONA_PACK39_TECH_DEBT_ERADICATION_PLAN.md`), and have been removed from
this generic backlog list accordingly so they are tracked in exactly one place.)
