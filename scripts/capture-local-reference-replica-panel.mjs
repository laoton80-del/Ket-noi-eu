/**
 * Local reference replica panel screenshot QA (hub-only).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-reference-replica-panel'
);
...
const VIEWPORTS = [
  { name: 'local-replica-390x844', width: 390, height: 844 },
  { name: 'local-replica-844x390', width: 844, height: 390 },
  { name: 'local-replica-768x1024', width: 768, height: 1024 },
  { name: 'local-replica-1024x768', width: 1024, height: 768 },
  { name: 'local-replica-1366x768', width: 1366, height: 768 },
];
