/**
 * Local card art-direction reset screenshot QA (hub-only, intent dismissed).
...
const OUT_DIR = path.join(__dirname, '..', 'docs', 'design', 'evidence', 'wave-3b-local-card-art-direction-reset');
...
const VIEWPORTS = [
  { name: 'local-art-reset-390x844', width: 390, height: 844 },
  { name: 'local-art-reset-844x390', width: 844, height: 390 },
  { name: 'local-art-reset-768x1024', width: 768, height: 1024 },
  { name: 'local-art-reset-1024x768', width: 1024, height: 768 },
  { name: 'local-art-reset-1366x768', width: 1366, height: 768 },
];
