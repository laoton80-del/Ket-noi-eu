/**
 * Travel Local grammar + Travel soul QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-use-local-grammar-with-travel-soul'
);
...
const VIEWPORTS = [
  { name: 'travel-local-grammar-390x844', width: 390, height: 844 },
  { name: 'travel-local-grammar-844x390', width: 844, height: 390 },
  { name: 'travel-local-grammar-768x1024', width: 768, height: 1024 },
  { name: 'travel-local-grammar-1024x768', width: 1024, height: 768 },
  { name: 'travel-local-grammar-1366x768', width: 1366, height: 768 },
  { name: 'travel-local-grammar-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
