/**
 * Travel secondary zone polish — Destination + Local Assistance + connected chips.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-secondary-premium-local-assist-polish'
);
...
const VIEWPORTS = [
  { name: 'travel-secondary-390x844', width: 390, height: 844 },
  { name: 'travel-secondary-768x1024', width: 768, height: 1024 },
  { name: 'travel-secondary-1024x768', width: 1024, height: 768 },
  { name: 'travel-secondary-1366x768', width: 1366, height: 768 },
  { name: 'travel-secondary-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
  ...
  for (const route of ['/travel', '/tabs/travel', '/TravelHub']) {
    ...
    const ok = await page
      .waitForFunction(
        () =>
          Boolean(
            document.querySelector('[data-testid="travel-destination-card"]') ||
