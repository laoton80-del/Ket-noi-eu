...
| FC-P0 Local provider authority E8 Case B B1A Vercel staging project provisioning | **BLOCKED — CLI UNAVAILABLE** — operator phrase `APPROVE_VIONA_FC_P0_LOCAL_PROVIDER_AUTHORITY_E8_CASE_B_B1A_DEDICATED_VERCEL_STAGING_PROJECT_PROVISIONING_AND_LOCAL_LINK_ONLY`; baseline `331d610…`; stopped before mutation: `BLOCKED_B1A_VERCEL_CLI_NOT_AVAILABLE`; project create 0; link 0; deploy 0; Git connect 0; blockers preserved; B1B–B7 unauthorized; E8–E10 unauthorized. Evidence: `docs/product/VIONA_FC_P0_LOCAL_PROVIDER_AUTHORITY_E8_CASE_B_B1A_VERCEL_STAGING_PROJECT_PROVISIONING_RESULT.md`. |
