/**
 * Travel Quick Help border contrast final — Pack 10 QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-quick-help-border-contrast-final-pack-10'
);
const BASE = process.env.VIONA_WEB_BASE ?? `http://localhost:${process.env.EXPO_CAPTURE_PORT || 8095}`;

const SHOTS = [
  { name: 'travel-1366x768-normal-quickhelp-default', width: 1366, height: 768, clip: 'travel-flagship-cards-row' },
  ...
  { name: 'travel-1366x768-normal-transport-active', width: 1366, height: 768, click: 'travel-flagship-taxi' },
  { name: 'travel-1366x768-normal-emergency-active', width: 1366, height: 768, click: 'travel-flagship-emergency' },
  { name: 'travel-1366x768-fullscreen-quickhelp-default', width: 1366, height: 768, fullscreen: true, clip: 'travel-flagship-cards-row' },
...
for (const shot of SHOTS) {
  ...
  if (shot.clip) {
    const el = page.locator(`[data-testid="${shot.clip}"]`);
