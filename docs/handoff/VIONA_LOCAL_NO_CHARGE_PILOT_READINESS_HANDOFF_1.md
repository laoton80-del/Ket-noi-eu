...
**Wave 2 native run:** `docs/runbooks/VIONA_WAVE_2_NATIVE_MOBILE_CONFIDENCE_RUN.md` — **NOT RUN** @ 2026-05-24; native **NOT COMPLETED**.
**Wave 3 consumer UX:** `VIONA_WAVE_3_CONSUMER_UX_EXCELLENCE_PREP.md` + `VIONA_WAVE_3_CONSUMER_UX_SURFACE_AUDIT.md` — surface audit **complete**; next: Premium App Tile rules doc.
