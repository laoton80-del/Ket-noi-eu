/**
 * Local reference 100% match MICRO-FINAL screenshot QA (hub-only).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-reference-100-match-micro-final'
);
...
const VIEWPORTS = [
  { name: 'local-micro-390x844', width: 390, height: 844 },
  { name: 'local-micro-844x390', width: 844, height: 390 },
  { name: 'local-micro-768x1024', width: 768, height: 1024 },
  { name: 'local-micro-1024x768', width: 1024, height: 768 },
  { name: 'local-micro-1366x768', width: 1366, height: 768 },
];
