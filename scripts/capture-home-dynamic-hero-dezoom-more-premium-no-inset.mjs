/**
 * Home dynamic hero de-zoom more premium (no inset) QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-home-dynamic-hero-dezoom-more-premium-no-inset'
);
...
const VIEWPORTS = [
  { name: 'home-dezoom-premium-390x844', width: 390, height: 844 },
  { name: 'home-dezoom-premium-844x390', width: 844, height: 390 },
  { name: 'home-dezoom-premium-768x1024', width: 768, height: 1024 },
  { name: 'home-dezoom-premium-1024x768', width: 1024, height: 768 },
  { name: 'home-dezoom-premium-1366x768', width: 1366, height: 768 },
];
...
async function main() {
  ...
  try {
    ...
    for (const world of WORLD_HOVERS) {
      ...
      const out = path.join(OUT_DIR, `home-dezoom-premium-1366x768-${world.key}.png`);
