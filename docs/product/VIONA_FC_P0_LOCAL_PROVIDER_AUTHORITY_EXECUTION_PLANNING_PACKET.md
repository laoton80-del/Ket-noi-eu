...
| E2 staging migration apply | `PLANNED` / **NOT AUTHORIZED** |
...
| E2 | `…_STAGING_MIGRATION_APPLY` | TBD | staging DB | TBD | E1 VERIFIED | migrate deploy | schema + zero rows | — | TBD | §16 | §7.1 | E3 | deploy/activation/QA |
