/**
 * Local opening visual polish QA screenshots.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-opening-visual-polish-before-commit'
);
...
const VIEWPORTS = [
  { name: 'local-opening-polish-390x844', width: 390, height: 844 },
  { name: 'local-opening-polish-844x390', width: 844, height: 390 },
  { name: 'local-opening-polish-768x1024', width: 768, height: 1024 },
  { name: 'local-opening-polish-1024x768', width: 1024, height: 768 },
  { name: 'local-opening-polish-1366x768', width: 1366, height: 768 },
];
