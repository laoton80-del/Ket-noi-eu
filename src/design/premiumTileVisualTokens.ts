...
export const premiumTileGlass = {
  ...
  innerHighlightHover: 'rgba(255, 255, 255, 0.12)',
...
export const premiumUniverseAccentMap: Readonly<Record<VionaUniverseAccent, PremiumUniverseAccentSpec>> = {
  emerald: {
    ink: '#78E8C4',
    inkHover: '#9CFFEA',
    stroke: 'rgba(72, 210, 165, 0.88)',
    strokeHover: 'rgba(92, 255, 224, 0.96)',
    glow: 'rgba(72, 210, 165, 0.22)',
    glowHover: 'rgba(92, 255, 224, 0.38)',
    glowPressed: 'rgba(72, 210, 165, 0.16)',
    statusFill: 'rgba(72, 210, 165, 0.16)',
    statusFillHover: 'rgba(92, 255, 224, 0.22)',
    iconCapsuleFill: 'rgba(72, 210, 165, 0.12)',
    iconCapsuleFillHover: 'rgba(92, 255, 224, 0.18)',
    cornerWash: 'rgba(72, 210, 165, 0.1)',
    cornerWashHover: 'rgba(92, 255, 224, 0.18)',
  },
  cyan: {
    ink: '#8CD4FF',
    inkHover: '#B8E8FF',
