/**
 * Local duplicate-card cleanup + LOCAL FOR YOU expansion QA capture.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-remove-duplicate-cards-expand-local-for-you'
);
...
const VIEWPORTS = [
  { name: 'local-remove-duplicate-390x844', width: 390, height: 844 },
  { name: 'local-remove-duplicate-844x390', width: 844, height: 390 },
  { name: 'local-remove-duplicate-768x1024', width: 768, height: 1024 },
  { name: 'local-remove-duplicate-1024x768', width: 1024, height: 768 },
  { name: 'local-remove-duplicate-1366x768', width: 1366, height: 768 },
];
...
async function main() {
  ...
  try {
    for (const vp of VIEWPORTS) {
      ...
      await page.waitForSelector('[data-testid="local-classified-cf_001"]', { timeout: 60_000 });
