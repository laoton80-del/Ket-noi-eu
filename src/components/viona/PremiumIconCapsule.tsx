 ...
 * `accent` = semanticFeatureAccent (see `VIONA_SEMANTIC_COLOR_MAPPING_V1.md`); not necessarily hub leading color.
 * Feature tiles inside one universe may use different accents (controlled multicolor).
