/**
 * Travel Local-style hover / hero lighting / dynamic frame QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-local-style-hover-lighting-and-dynamic-frame'
);
...
const VIEWPORTS = [
  { name: 'travel-hover-frame-390x844', width: 390, height: 844 },
  { name: 'travel-hover-frame-844x390', width: 844, height: 390 },
  { name: 'travel-hover-frame-768x1024', width: 768, height: 1024 },
  { name: 'travel-hover-frame-1024x768', width: 1024, height: 768 },
  { name: 'travel-hover-frame-1366x768', width: 1366, height: 768 },
  { name: 'travel-hover-frame-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
