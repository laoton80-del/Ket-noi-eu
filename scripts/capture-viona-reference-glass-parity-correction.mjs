/**
 * VIONA reference glass parity correction — Local screenshot QA.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-reference-glass-parity-correction'
);
...
const VIEWPORTS = [
  { name: 'glass-parity-390x844', width: 390, height: 844 },
  { name: 'glass-parity-844x390', width: 844, height: 390 },
  { name: 'glass-parity-768x1024', width: 768, height: 1024 },
  { name: 'glass-parity-1024x768', width: 1024, height: 768 },
  { name: 'glass-parity-1366x768', width: 1366, height: 768 },
];
