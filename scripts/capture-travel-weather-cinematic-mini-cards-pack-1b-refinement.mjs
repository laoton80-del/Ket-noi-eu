/**
 * Travel weather cinematic mini cards pack 1B refinement — QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-weather-cinematic-mini-cards-pack-1b-refinement'
);
...
const VIEWPORTS = [
  { name: 'weather-1b-390x844', width: 390, height: 844 },
  { name: 'weather-1b-768x1024', width: 768, height: 1024 },
  { name: 'weather-1b-1024x768', width: 1024, height: 768 },
  { name: 'weather-1b-1366x768', width: 1366, height: 768 },
  { name: 'weather-1b-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
...
async function openTravelRoute(page) {
  ...
  throw new Error('Travel weather 1B readiness failed.');
}
