/**
 * Local command-center panel screenshot QA (hub-only).
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-command-center-panel'
);
...
const VIEWPORTS = [
  { name: 'local-cc-390x844', width: 390, height: 844 },
  { name: 'local-cc-844x390', width: 844, height: 390 },
  { name: 'local-cc-768x1024', width: 768, height: 1024 },
  { name: 'local-cc-1024x768', width: 1024, height: 768 },
  { name: 'local-cc-1366x768', width: 1366, height: 768 },
];
