...
const mockBookings: Booking[] = [
  ...
  {
    id: 'bk_1100',
    customerName: 'Tran Minh Khoa',
    customerPhone: '+420777888999',
    startTime: isoAt(11, 0),
    endTime: isoAt(12, 0),
    status: 'inquiry',
    handoffSummary: 'Khach goi hoi lam nail 2 nguoi, co dinh da, xin den muon 15p.',
  },
  {
    id: 'bk_1245',
    customerName: 'Le Thi Quynh',
    customerPhone: '+420601234567',
    startTime: isoAt(12, 45),
    endTime: isoAt(13, 30),
    status: 'inquiry',
    handoffSummary: 'Khach can dat lich gap cho dich vu tu van giay to, uu tien khung gio sau 13:00.',
  },
  {
    id: 'bk_1430',
