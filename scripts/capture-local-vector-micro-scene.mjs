/**
 * Local vector micro-scene screenshot QA (hub-only, intent dismissed).
...
const OUT_DIR = path.join(__dirname, '..', 'docs', 'design', 'evidence', 'wave-3b-local-vector-micro-scene');
...
const VIEWPORTS = [
  { name: 'local-vector-390x844', width: 390, height: 844 },
  { name: 'local-vector-844x390', width: 844, height: 390 },
  { name: 'local-vector-768x1024', width: 768, height: 1024 },
  { name: 'local-vector-1024x768', width: 1024, height: 768 },
  { name: 'local-vector-1366x768', width: 1366, height: 768 },
];
