/**
 * Travel Experience Intelligence Zone — cinematic QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-secondary-cinematic-experience-zone'
);
...
const VIEWPORTS = [
  { name: 'travel-cinematic-390x844', width: 390, height: 844 },
  { name: 'travel-cinematic-768x1024', width: 768, height: 1024 },
  { name: 'travel-cinematic-1024x768', width: 1024, height: 768 },
  { name: 'travel-cinematic-1366x768', width: 1366, height: 768 },
  { name: 'travel-cinematic-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
...
async function scrollForViewport(page, mobile) {
  await page.evaluate(({ mobile: isMobile }) => {
    ...
    if (isMobile) window.scrollBy(0, 56);
  }, { mobile });
...
async function measureMobileOverlap(page) {
  return page.evaluate(() => {
    ...
    return {
      ...
      cardClearance: cardRect ? Math.round(vh - cardRect.bottom) : null,
    };
  });
}
