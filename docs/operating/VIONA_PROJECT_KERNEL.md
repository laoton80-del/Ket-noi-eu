...
**Controlled pilot session 2:** `VIONA_LOCAL_NO_CHARGE_CONTROLLED_PILOT_SESSION_2.md` — user/merchant + ops API **PASS** @ `028ea9f`; Expo ops UI **PASS** @ §5. **Android dev client build:** **PASS** @ §11.6 (`VIONA.NATIVE.ANDROID.DEV_CLIENT_MAPBOX_BUILD_FIX.1`) — `com.ketnoiglobal.app` installable; **native secret-tap:** **NOT RUN** @ §11.3/§11.5. Local: `REQUEST_ONLY_NO_CHARGE`, `walletPhase` **NONE**. **Not** production/commercial.
