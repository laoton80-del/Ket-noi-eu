/**
 * Local card layout WOW tuning screenshot QA (hub-only, intent dismissed).
...
const OUT_DIR = path.join(__dirname, '..', 'docs', 'design', 'evidence', 'wave-3b-local-card-layout-wow');
...
const VIEWPORTS = [
  { name: 'local-layout-wow-390x844', width: 390, height: 844 },
  { name: 'local-layout-wow-844x390', width: 844, height: 390 },
  { name: 'local-layout-wow-768x1024', width: 768, height: 1024 },
  { name: 'local-layout-wow-1024x768', width: 1024, height: 768 },
  { name: 'local-layout-wow-1366x768', width: 1366, height: 768 },
];
