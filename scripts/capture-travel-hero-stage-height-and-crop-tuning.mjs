/**
 * Travel hero stage height + crop tuning QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-hero-stage-height-and-crop-tuning'
);
...
const VIEWPORTS = [
  { name: 'travel-hero-stage-390x844', width: 390, height: 844 },
  { name: 'travel-hero-stage-844x390', width: 844, height: 390 },
  { name: 'travel-hero-stage-768x1024', width: 768, height: 1024 },
  { name: 'travel-hero-stage-1024x768', width: 1024, height: 768 },
  { name: 'travel-hero-stage-1366x768', width: 1366, height: 768 },
  { name: 'travel-hero-stage-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
