/**
 * VIONA reference visual engine — Local command-center screenshot QA.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-reference-visual-engine-local'
);
...
const VIEWPORTS = [
  { name: 'ref-engine-390x844', width: 390, height: 844 },
  { name: 'ref-engine-844x390', width: 844, height: 390 },
  { name: 'ref-engine-768x1024', width: 768, height: 1024 },
  { name: 'ref-engine-1024x768', width: 1024, height: 768 },
  { name: 'ref-engine-1366x768', width: 1366, height: 768 },
];
