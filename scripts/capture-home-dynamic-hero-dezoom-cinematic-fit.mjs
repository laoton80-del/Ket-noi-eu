/**
 * Home dynamic hero de-zoom cinematic fit QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-home-dynamic-hero-dezoom-cinematic-fit'
);
...
const VIEWPORTS = [
  { name: 'home-hero-dezoom-390x844', width: 390, height: 844 },
  { name: 'home-hero-dezoom-844x390', width: 844, height: 390 },
  { name: 'home-hero-dezoom-768x1024', width: 768, height: 1024 },
  { name: 'home-hero-dezoom-1024x768', width: 1024, height: 768 },
  { name: 'home-hero-dezoom-1366x768', width: 1366, height: 768 },
];
...
async function main() {
  ...
  try {
    ...
    for (const world of WORLD_HOVERS) {
      ...
      const out = path.join(OUT_DIR, `home-hero-dezoom-1366x768-${world.key}.png`);
