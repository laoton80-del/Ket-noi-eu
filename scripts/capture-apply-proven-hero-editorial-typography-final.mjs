/**
 * Apply proven hero editorial typography final — QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-apply-proven-hero-editorial-typography-final'
);
...
const ROUTE_CONFIG = {
  travel: {
    ...
    ready: '[data-testid="travel-hero-title"]',
  },
  local: {
    routes: ['/local', '/tabs/local', '/LocalHub'],
    ready: '[data-testid="local-hero-title"]',
  },
};
