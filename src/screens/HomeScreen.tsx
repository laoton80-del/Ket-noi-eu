...
const styles = StyleSheet.create({
  ...
  multiverseHeroCard: {
    marginTop: 14,
    borderRadius: 26,
    borderColor: 'rgba(33, 81, 154, 0.18)',
  ...
  multiverseGlow: {
    ...
    height: 170,
    borderRadius: 110,
    backgroundColor: 'rgba(85, 143, 232, 0.14)',
  },
  multiverseEyebrow: {
    fontSize: 11,
    letterSpacing: 0.6,
    textTransform: 'uppercase',
    color: 'rgba(24, 66, 132, 0.82)',
    fontFamily: FontFamily.semibold,
    marginBottom: 6,
  },
  multiverseHeadline: {
  ...
  universeCard: {
    ...
    borderRadius: 16,
    borderWidth: 1,
    borderColor: 'rgba(33, 81, 154, 0.16)',
  ...
  universeIconWrap: {
    ...
    backgroundColor: 'rgba(33, 81, 154, 0.11)',
    marginBottom: 8,
  },
  universeTitle: {
    fontSize: 14,
