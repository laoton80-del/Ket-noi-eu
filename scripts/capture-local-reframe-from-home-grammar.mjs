/**
 * Local reframe from Home grammar — opening stage screenshot QA.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-local-reframe-from-home-grammar'
);
...
const VIEWPORTS = [
  { name: 'local-reframe-390x844', width: 390, height: 844 },
  { name: 'local-reframe-844x390', width: 844, height: 390 },
  { name: 'local-reframe-768x1024', width: 768, height: 1024 },
  { name: 'local-reframe-1024x768', width: 1024, height: 768 },
  { name: 'local-reframe-1366x768', width: 1366, height: 768 },
];
