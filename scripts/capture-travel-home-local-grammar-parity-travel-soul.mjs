/**
 * Travel Home/Local grammar parity QA captures.
...
const OUT_DIR = path.join(
  ...
  'design',
  'evidence',
  'wave-3b-travel-home-local-grammar-parity-travel-soul'
);
...
const VIEWPORTS = [
  { name: 'travel-grammar-parity-390x844', width: 390, height: 844 },
  { name: 'travel-grammar-parity-844x390', width: 844, height: 390 },
  { name: 'travel-grammar-parity-768x1024', width: 768, height: 1024 },
  { name: 'travel-grammar-parity-1024x768', width: 1024, height: 768 },
  { name: 'travel-grammar-parity-1366x768', width: 1366, height: 768 },
  { name: 'travel-grammar-parity-1366x768-fullscreen', width: 1366, height: 768, fullscreen: true },
];
